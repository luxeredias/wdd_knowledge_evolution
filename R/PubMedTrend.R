...
PubMedTrend <- function(query, yrStart=1950, yrMax=2009) {
  ...
  getCount <- function(query.term) {
    ...
    for(i in yrStart:yrMax) {
      ...
      pub.esearch <- getURL(paste("https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&api_key=42f9ff230d26b4a045680973c38549d5e708&rettype=count&term=", 
